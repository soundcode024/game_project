...
void Wall::draw_wall(N5110 &lcd, int gap_y_pos, int wall_gap, float wall_speed) {
    ...
    lcd.drawSprite( _wall_x_pos, (gap_y_pos-wall_gap-48), 48, 10, (int*)top_wall); // the wall sprites are the height of the entire screen so they can be drawn partly out of the screen depending on required gap size and gap position
